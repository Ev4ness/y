...
async def add_userdata(
    chat_id: int, user_id: int, username: str, first_name: str, last_name: str, bio: str
):
...
async def chk_usr(_, message: Message):
    ...
    if (
        ...
        or bio_before != message.from_user.bio
    ):
        ...
        if usernamebefore != message.from_user.username:
            msg += f"""ᴜsᴇʀ **{message.from_user.mention}** ᴄʜᴀɴɢᴇᴅ ʜᴇʀ ᴜsᴇʀɴᴀᴍᴇ ғʀᴏᴍ @{usernamebefore} ᴛᴏ @{message.from_user.username}\n"""

        if bio_before != message.from_user.bio:
            msg += f"""ᴜsᴇʀ **{message.from_user.mention}** ᴄʜᴀɴɢᴇᴅ ʜᴇʀ ʙɪᴏ ғʀᴏᴍ "{bio_before}" ᴛᴏ "{message.from_user.bio}"\n"""
